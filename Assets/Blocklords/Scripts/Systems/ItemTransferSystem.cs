...
{
    private readonly string walletKey = "wallet";
    private string itemContractAddress = "0463e00d9200830853c33ce16fe804e86af814aa";
    private string itemWalletAddress = "AZUE49z4N3H2yky8UkgDNBj4VUM2UA259d";
    private string assetID = "602c79718b16e442de58778e148d0b1084e3b2dffd5de6b7b16cee7969282de7";
    private UInt160 itemContract;
    ...
    private readonly int blockDelay = 20;       // In Seconds
    private NeoAPI api;

    private MarketItem marketItem;
    private Item creatingItem;

    private IDisposable blockEnd;
    ...
    public override void Initialize(IEventSystem eventSystem, IPoolManager poolManager, GroupFactory groupFactory)
    {
        ...
        EventSystem.OnEvent<BuyItemEvent>().Subscribe(evt =>
        {
            StartCoroutine(BuyItem(evt.marketItem));
        });

        EventSystem.OnEvent<CreateItemEvent>().Subscribe(evt =>
        {
            StartCoroutine(CreateItem(evt.item));
        });
    ...
    private IEnumerator BuyItem(MarketItem marketItem)
    {
    ...
    private IEnumerator CreateItem(Item item)
    {
        yield return new WaitForSeconds(5);
        try
        {
            ...
            else
            {
                ...
                string itemParameters = item.BaseStats.ToString().PadLeft(4, '0');
                itemParameters += item.MaxStats.ToString().PadLeft(4, '0');
    ...
    private IEnumerator WaitForTransaction()
    {
        if (tx == null)
        {
